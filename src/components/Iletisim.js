      ...
      <div className="iletişim-cont">
        <div className="iletişim">
          ...
          <div style={{ textAlign: "center", margin: "25px 10px 10px" }}>
            <a rel="noopener noreferrer" target="_blank" href={isMobile ? "https://wa.me/908503072610" : "https://web.whatsapp.com/send?phone=908503072610"} style={{ display: "inline-flex", background: "white", border: "2px solid rgb(39 39 39)", padding: "3px", borderRadius: "10px", alignItems: "center" }}>
