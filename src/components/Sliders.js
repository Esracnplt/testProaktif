...
class Slider extends React.Component {
    ...
    render() {
        if (this.state.render) {
            return(
                <React.Fragment>
                    <img src={slider1img} style={{width:"100%"}} alt="slider" className="blur slider-img">
...
class Slider2 extends React.Component {
    ...
    render(){
        if (this.state.render) {
            return (
                <React.Fragment>
                    <img src={slider2img} style={{width:"100%"}} alt="slider" className="blur slider-img">
...
class Slider3 extends React.Component {
    ...
    render(){
        if (this.state.render) {
            return (
                <React.Fragment>
                    <img src={slider3img} style={{width:"100%"}} alt="slider" className="blur slider-img">
...
class ButtonArrow extends React.Component {
    componentDidMount() {
        let button = this
        document.getElementsByClassName("arrow-" + this.props.side)[0].onmousedown = function() {
    ...
    render() {
        return(
            <div className={((this.props.side === "left")?"arrow-left":"arrow-right") + " arrow-button center"}>
                {
